...
const { shallowEqualAll, log } = require('./utils')
...
const configure = (write, geometry) => {
  osdWrite = write
  osd.setGeometry(geometry)
}

const updateLayout = (elems, doRender = false) => {
...
const render = debounce(renderImmediate, 100)
