...
#### Вариант B: Использование примера конфигурации
...
Затем отредактируйте файл `.env` и установите нужные значения.
...
**Полный список всех параметров:** [docs/ru/env-variables.md](docs/ru/env-variables.md)
